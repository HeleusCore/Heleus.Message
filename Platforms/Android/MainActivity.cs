...
{
	[Activity(Label = "Heleus Message", Icon = "@mipmap/icon", RoundIcon = "@mipmap/icon_round", Theme = "@style/SplashTheme", MainLauncher = true, AlwaysRetainTaskState = true,
