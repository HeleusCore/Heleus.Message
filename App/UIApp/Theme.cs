...
namespace Heleus.Apps.Shared
{
    ...
    class MessageButtonStyle : IButtonStyle
    {
        public ColorStyle Color => Theme.RowDisabledColor;
        public ColorStyle HoverColor => Theme.RowDisabledColor;
        public ColorStyle HighlightColor => Theme.RowDisabledColor;
    ...
    static partial class Theme
	{
        ...
        public static readonly IButtonStyle MessageButton = new MessageButtonStyle();

        static readonly Color Primary = Color.FromRgb(50,180,10); // #32B40A
		static readonly Color Secondary = Color.FromRgb(40,130,20); // #288214
